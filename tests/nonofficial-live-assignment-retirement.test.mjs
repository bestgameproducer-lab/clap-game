...
test('live mode retires every unfinished task outside the exact official manifest', async () => {
  ...
  const guarded = [...migration.matchAll(/'(P[12]-[A-Z0-9-]+)'/g)].map((match) => match[1]);
