...
一个适合婚礼现场使用的轻量扫码网页：宾客先输入共享婚礼邀请码，再从名单中选择自己并用个人认领码完成一次性认领；之后可查看秘密任务、提交完成、查看线索并参与最终投票。主办方可以控制注册与婚礼阶段、重置误认领、审核任务、加分、开放投票和公布结果。
...
每个宾客身份只能认领一次。需要重新演示时，在主办方控制台的“宾客进度”中点击“重置”。
