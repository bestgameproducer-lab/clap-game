...
export default async function CloudProjectPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  const { project, versions, entitlement, reviews, members, invitations, deliveryEvents, quoteRequests, commercialQuotes } = details;
