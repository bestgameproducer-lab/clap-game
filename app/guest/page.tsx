...
export default function GuestPage() {
  ...
  const allDashboardAssignments = usesTricksterFacade ? data.assignments.filter((assignment) => assignment.task.category !== 'hidden') : data.assignments;
  ...
  return <main className="dashboard-shell">
    ...
    {isActivePlayer && <section className="section-card" id="guest-missions"><div className="section-heading"><div><small>SECRET MISSIONS</small><h2>我的秘密任务</h2></div><span>{openAssignments.length} 待处理</span></div>
