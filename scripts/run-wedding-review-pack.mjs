...
const roleReviewSteps = [
  ...
  ['40d-role-siran-random-player', '李思冉回归随机玩家池', '不再持有固定应援身份，可抽到普通任务或随机能力。', '宾客端 · 角色矩阵'],
  ['40e-role-moshuang-random-player', '徐莫双回归随机玩家池', '不再持有固定应援身份，可抽到普通任务或随机能力。', '宾客端 · 角色矩阵'],
...
const steps = [
  ...
  ['11d-lonely-cupid-choice', '孤单丘比特偷心行动', '任务内解释来源并锁定一名竞技玩家，最终揭晓时转移 3 分。', '宾客端'],
  ...
  ['12g-lucky-star-ledger', '超级幸运星结算', '两位固定幸运星都以主能力卡获得“第一幕积分快照 + 2”的自动奖励。', '宾客端'],
  ...
  ['23g-host-quick-quiz', '主持人快问快答题库', '三组使用相同题序，主持人控制答案遮罩、答对推进和答错终止。', '主持人端 · 游戏助手'],
  ['23h-host-charades', '主持人你比划我猜词库', '显示五分钟计时、当前词、答对与跳过记录。', '主持人端 · 游戏助手'],
  ['23i-host-random-number', '主持人随机数工具', '提供 1–10、0–9 和自定义整数范围的独立随机抽取。', '主持人端 · 游戏助手'],
