-- Keep the login roster aligned with the wedding's social order while preserving
-- every account, session, assignment, role, and score record.
...
values(
  'migration:202608020006',
  'guest.registration_order_updated',
  'game_state',
  '1',
  jsonb_build_object('order',jsonb_build_array('新郎','新娘','家人组','海岛组','沙漠组','其他'),'runtime_preserved',true)
);
