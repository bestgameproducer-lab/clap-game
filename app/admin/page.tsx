...
export default function AdminPage() {
  ...
  return <main className="admin-shell">
    ...
    <section className="section-card finale-workflow-card">
      ...
      <p className="muted">按顺序完成颁奖准备、最终投票和公开揭晓。点击“公布身份并结算”时，系统会一次性结算投票、队伍奖励和第二阶段能力积分。</p>
    ...
    <section className="admin-grid">
      ...
      <article className="section-card finale-guide-card"><div className="section-heading"><div><small>OPERATOR NOTE</small><h2>主持操作提示</h2></div></div><ol><li>先在下方确认需要公开的奖项和获奖人。</li><li>开启投票后，等待现场宾客完成提交，再关闭投票。</li><li>确认投票结果无误后，公布身份并自动结算终局积分。</li><li>现场颁奖，最后核对积分流水；需要展示时再开放大屏。</li></ol></article>
    </section>
